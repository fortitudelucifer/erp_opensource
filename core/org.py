# -*- coding: utf-8 -*-
"""
org.py - 组织架构管理模块 / Organization Management Module

本模块处理部门和人员的增删改查操作：
This module handles CRUD operations for departments and personnel:

- list_departments: 部门列表 / List departments
- new_department: 新增部门 / Create department
- delete_department: 删除部门 / Delete department
- list_persons: 人员列表 / List personnel
- new_person: 新增人员 / Create personnel
- edit_person: 编辑人员 / Edit personnel
- delete_person: 删除人员 / Delete personnel
