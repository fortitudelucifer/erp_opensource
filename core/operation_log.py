# -*- coding: utf-8 -*-
"""
operation_log.py - 操作日志记录模块 / Operation Log Recording Module

本模块提供统一的操作日志记录入口：
This module provides a unified entry point for operation log recording:

- log_operation(): 记录操作日志的核心函数 / Core function to record operation logs
- 支持记录变更前后的数据快照 / Support for before/after data snapshots
- 自动捕获操作者 IP 地址 / Automatic capture of operator IP address
