# -*- coding: utf-8 -*-
"""
logs.py - 操作日志展示模块 / Operation Logs Display Module

本模块处理操作日志的查询和展示：
This module handles the querying and display of operation logs:

- list_logs: 全局操作日志列表 / Global operation logs list
- contract_logs: 单个合同的日志 / Logs for a specific contract
- 支持多维度筛选 / Multi-dimensional filtering support

Features / 功能特点:
- 对象类型/动作类型的中文本地化 / Localization for object types and actions
- 详情 JSON 格式化展示 / Formatted display of detail JSON
- 日期范围筛选 / Date range filtering
