# -*- coding: utf-8 -*-
"""
acceptance_service.py - 验收服务模块 / Acceptance Service Module

本模块封装验收相关的业务逻辑：
This module encapsulates the business logic for acceptance:

- get_summary_for_contract: 获取合同验收统计 / Get acceptance summary for contract

Acceptance Status / 验收状态:
进行中 → 通过 / 驳回
In Progress → Passed / Rejected
