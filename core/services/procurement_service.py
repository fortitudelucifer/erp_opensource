# -*- coding: utf-8 -*-
"""
procurement_service.py - 采购服务模块 / Procurement Service Module

本模块封装采购相关的业务逻辑：
This module encapsulates the business logic for procurement:

- create_item: 创建采购条目 / Create procurement item
- update_status: 更新采购状态 / Update procurement status
- 集成通知服务 / Integrated notification service

Procurement Status / 采购状态:
未采购 → 已下单 → 运输中 → 已到货
Not Purchased → Ordered → In Transit → Arrived
...
from ..models import ProcurementItem, Contract
