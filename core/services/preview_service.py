# -*- coding: utf-8 -*-
"""
preview_service.py - 文件预览服务模块 / File Preview Service Module

本模块负责 Office 文件的预览版本生成：
This module handles preview version generation for Office files:

- get_or_generate_office_preview: 获取或生成 Office 预览 PDF / Get or generate Office preview PDF
...
Implementation / 实现方式:
- 使用 LibreOffice 进行 PDF 转换 / Use LibreOffice for PDF conversion
- 支持预览缓存避免重复转换 / Support preview caching to avoid repeated conversion
